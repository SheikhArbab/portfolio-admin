  ...
  return (
    <>
      ...
      <nav className="relative px-4 py-4 flex justify-between items-center glass">
        ...
        <img
          className="hidden object-cover w-9 h-9 lg:inline-block lg:ml-auto lg:mr-3 border border-primaryPink border-3 bg-gray-50  text-sm text-gray-900 font-bold  rounded-full transition duration-200"
          src={user.avatar}
        />
